...
export default function HomeHeader() {
  ...
  return (
    <View 
      ...
      className="flex-row items-center justify-between px-5 pb-4 bg-gradient-to-b from-black/80 to-transparent"
    >
      {/* Branding Logo */}
      <View>
        <AppText 
        ...
        >
          HOUSE OF <AppText style={{ color: "#4F8CFF", fontFamily: "InterBold" }}>EDTECH</AppText>
        </AppText>
      </View>

      {/* Right controls */}
      <View className="flex-row items-center gap-3">
        <HeaderButton icon="search-outline" onPress={() => console.log("Search pressed")} />
        <HeaderButton icon="notifications-outline" badge onPress={() => console.log("Notifications pressed")} />
